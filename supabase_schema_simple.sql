-- GKR Sweets Database Schema - SIMPLIFIED VERSION
...
INSERT INTO site_settings (key, value, category, description) VALUES
  ...
  ('footer_about', '"GKR Sweets is your destination for authentic traditional Indian sweets and snacks."', 'footer', 'About text in footer'),
